        ...
        <div onClick={e => e.stopPropagation()} className="
          ...
          <div className="modal__header flex justify-between">
            <div className="modal__info">
              ...
              gap-2 cursor-pointer text-white/60 
              hover:text-orange-500 transition-colors">
                <h2 className="inline text-xl border-b-2 border-dotted">{t("cardModal.link")}</h2>
              ...
              <div
                ...
                className={`mt-5 border-t border-b max-w-50 
                border-white/40 py-3 flex items-center text-orange-500
                justify-between cursor-pointer duration-500 ${expanded ? 'text-white' : null}`}>
                <span className="text-xl">
                  {t("cardModal.desc")}
                </span>
                <span
                  className={`text-2xl font-bold select-none transition-all duration-500 origin-center ${expanded ? 'rotate-45' : null}`}
                >
              ...
              <div className={`relative mt-5 max-w-120 text-base 
                ...
                <p>
                  {lang === "en" ? data.enDescription : data.ruDescription}
                </p>
              </div>
            </div>
